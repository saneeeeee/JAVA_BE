-- 서브쿼리
--		SubQuery : 하나의 select 문장의 절 안에 포함된 또하나의 select 쿼리 문
...
-- [연습문제] SCOTT 의 급여와 동일하거나 더많이 받는 사원이름과 급여 출력
...
-- [서브 쿼리 & IN , SOME , ANY 등]
-- 급여를 3000이상 받는 사원이 소속된 부서와 소속된 부서에서 근무하는 사원들의 이름, 부서번호 ,job
-- 급여 3000 이상 사원의 부서 번호(중복제거);
-- distinct 필드명 : 필드값의 중복된 값이 여러개라면 한번ㅁ나 출력
...
-- [연습문제]
-- 영업사원(job = 'SALESMAN') 들의 최소 급여보다 많이 받는 사워들의
