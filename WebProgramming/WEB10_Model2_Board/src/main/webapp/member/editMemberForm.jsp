...
<table>
	...
	<tr><th>이름</th><td><input type="text" name="name" value="${loginUser.name}">&nbsp;*</td></tr>
	<tr><th>이메일</th><td><input type="text" name="email" size="20" value="${loginUser.email}"></td>   </tr>
	<tr><th>전화번호</th><td><input type="text" name="phone" size="20" value="${loginUser.phone}"></td></tr>
	<tr><th>등급</th><td>
		<c:choose>
	...
	<tr><td colspan="2" align="center">
		<input type="submit" value="확인" onClick="return editCheck()" />
		<input type="reset" value="다시 작성">
		<input type="button" value="목록으로"
			onClick="location.href='board.do?command=main'"></td></tr>
</table>
</form>
</div>
</body>
