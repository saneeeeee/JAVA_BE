...
<div id="wrap" align="center">
	<h1>게시글 등록</h1>
	<form action="board.do?command=boardWrite" method="post" name="frm">
		<table>
			<tr><th>작성자</th><td>${loginUser.userid}<input 
			type="hidden" name="userid" value="${loginUser.userid}"></td></tr>
			<tr><th>비밀번호</th><td><input type="password" 
			name="pass"> * 필수 (게시물 수정, 삭제 시 필요합니다.)</td></tr>
			<tr><th>email</th><td><input type="text" 
			name="email" value="${loginUser.email}"></td></tr>
