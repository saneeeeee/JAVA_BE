...
<body>
<table>
	<tr><td>${loginUser.name}(${loginUser.userid})님 로그인하셨습니다&nbsp;&nbsp;
		${message}</td></tr>
	...
	<tr><td> <input type="button" value="로그아웃" onClick="location.href='logout.do'" />
				...
				<!-- 문자데이터들 사이에 EL 문법이 껴들어서 조합문자데이터 구성가능합니다 -->
				<input type="button" value="회원 탈퇴" onClick="withDrawConfirm()"></td></tr>						
				<!-- WithdrawalServlet -->
</table>
<br><br>
<c:if test="${loginUser.admin == 1}">
	<table  align="center" width="800" bgcolor="black" cellspacing="1">
		<tr bgcolor="white"><th>아이디</th><th>이름</th><th>전화번호</th>
				<th>이메일</th><th>등급</th><th>등급변경</th></tr>
