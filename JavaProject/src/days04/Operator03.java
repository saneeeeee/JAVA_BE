...
public class Operator03 {
	...
	public static void main(String[] args) {
		...
		// s1 과 s2 는 String 자료형이며, 다른 자료형과 다르게 이 두변수가 
		// 직접 문자들을 저장하고 있지 않습니다.
		// 문자들은 별도의 장소에 저장되고, 변수는 저장위치값만 저장하고 있습니다
		// 따라서 변수들간의 비교(s1>s2) 는 저장위치정보의 비교이므로 연산이 
		// 의미가 있지도 않고  가능하지도 않습니다
		...
		// s1.compareTo(s2);  이 명령은 
		// s1- s2 가 주소끼리 연산되므로, 
		// 주소를 찾아가서 직접 글자를 가져다가 뺄셈연산을 대신해주는 도구입니다.
		// 따라서 결과는 int 입니다
