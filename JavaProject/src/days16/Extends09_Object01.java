...
//	Object 클래스는 Java 에서 사용되는 모든 클래스들의 최상위 부모 클래스입니다.
//	Subclass extends Super 라는건 Subclass 는 Object를 상속하지 않지만
// Super 크래스가 Object 클래스를 상속하므로, Subclass 는 Object 클래스를
// 상위의 상위로 상속한 것과 같은 의미입니다.
