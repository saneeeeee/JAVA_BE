...
public class IO03 {
	...
	public static void main(String[] args) throws IOException {
		...
		//	자료형이 Byte라는건 배열 한칸에 -128~127 까지를 저장한다는 뜻입니다.
		//	입력 받은 하나의 숫자가 -128~127로 제한되는 것이 아니라...
		//	입력 받은 아라비아 기호의 아스키 코드 값이 -128~127까지 제한된다는 뜻입니다.
		
		System.out.print("첫번째 정수 : ");
		int size_1 = System.in.read(firstNumber);
		System.out.print("두번째 정수 : ");
		int size_2 = System.in.read(secondNumber);
		//	입력한 글자외에 데이터의 끝을 표시하는 글자와 입력한 엔터까지 저장되어서
		...
		*/
		...
		//	1234 입력시 size가 6이고 , i변수는 size-3번째(6-3 ) 부터 0까지 반복합니다
		//	그 처음이 '4'해당하는 배열 인덱스 3의 자리 글자입니다.
		//	그렇게 지목된 일의 자리의 글자부터 '0' 글자를 뺄셈해서 아스키 코드값의 차로 해당 숫자를 얻고
		//	각 반복마다 10이 계속 곱해지는 (1, 10, 10, ...) m 값을 곱해서 각 자리수를 만듭니다
		//	또한 그것을 n1 변수에 누적합니다
