...
public class IO05 {
	...
	public static void main(String[] args) throws IOException {
		...
		//	기능을 추가할 수 있습니다. : 데코레이션 패턴(객체에 다른클래스의 기능을 추가하여 사용)
		...
		String message = br.readLine();		//	최초로 입력 변수로 String이 사용됨
		System.out.printf("입력된 메세지는 %d 글자입니다.", message.length());
		System.out.println(message);
		//	스트림은 메모리 누수 현상을 방지하기 위해서 반드시 close 메서드를 호출하여 종료를해야함
